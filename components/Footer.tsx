...
export default function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', href: 'https://twitter.com/parinum', icon: TwitterIcon },
    { name: 'GitHub', href: 'https://github.com/parinum', icon: GitHubIcon },
    { name: 'Discord', href: 'https://discord.gg/parinum', icon: DiscordIcon },
  ]
