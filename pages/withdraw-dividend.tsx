        ...
        >
          <div className="bg-white/70 dark:bg-dark-800/50 backdrop-blur-sm border border-slate-500/20 rounded-3xl p-12 flex flex-col items-center">
            ...
            <p className="text-xl text-secondary-600 dark:text-slate-300 max-w-lg mx-auto leading-relaxed">
              Staking will be enabled at the end of the ICO.
            </p>
            <div className="mt-8">
              <span className="inline-flex items-center px-4 py-2 rounded-full bg-slate-200 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-secondary-600 dark:text-slate-400 text-sm">
                Coming Soon
              </span>
            </div>
          </div>
