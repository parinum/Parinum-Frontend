...
import { ConfirmPurchaseView } from '@/components/PurchaseFlowViews'
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ConfirmPurchaseView
            ...
            headerAction={
              <Link
                href="/how-to-purchase?step=confirm"
                className="inline-flex items-center gap-2 rounded-full border border-violet-500/25 bg-violet-500/10 px-4 py-2 text-sm font-semibold text-violet-700 transition-colors hover:bg-violet-500/15 dark:border-violet-400/30 dark:bg-violet-500/10 dark:text-violet-300 dark:hover:bg-violet-500/20"
              >
                <InfoIcon />
