...
import { confirmPurchase } from '@/lib/functions'
    ...
    <Layout>
      <div className="min-h-screen pt-20 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h3 className="text-lg font-semibold text-white mb-4">Confirmation Process</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-700 rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-3">
                  1
                </div>
                <h4 className="font-medium text-white mb-2">Enter Purchase ID</h4>
                <p className="text-sm text-dark-400">Provide the unique purchase identifier</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-700 rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-3">
                  2
                </div>
                <h4 className="font-medium text-white mb-2">Lock Collateral</h4>
                <p className="text-sm text-dark-400">Secure the transaction with collateral</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-700 rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-3">
                  3
                </div>
                <h4 className="font-medium text-white mb-2">Fulfill Order</h4>
                <p className="text-sm text-dark-400">Ship or deliver the product</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-700 rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-3">
                  4
                </div>
                <h4 className="font-medium text-white mb-2">Receive Payment</h4>
                <p className="text-sm text-dark-400">Get paid after buyer confirmation</p>
              </div>
            </div>
          </div>
        </div>
